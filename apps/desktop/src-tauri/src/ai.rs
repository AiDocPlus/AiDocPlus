...
pub static PROVIDER_REGISTRY: &[ProviderDefaults] = &[
    ...
    ProviderDefaults { id: "minimax",      base_url: "https://api.minimaxi.com/v1",                                  default_model: "MiniMax-M2.7",        auth_style: AuthStyle::Bearer,       default_temperature: 1.0, default_max_tokens: 16384 },
    ProviderDefaults { id: "minimax-code", base_url: "https://api.minimaxi.com/v1",                                  default_model: "MiniMax-M2.7",        auth_style: AuthStyle::Bearer,       default_temperature: 1.0, default_max_tokens: 16384 },
